...
insert into sk8line.TB_USERS(CD_USER, DC_NAME_USER, DC_PASSWORD, DC_NAME, IN_ADMIN_IND, DT_CREATE, DT_LAST_UPD) values(USERS_SEQ.NEXTVAL, 'admin','admin', 'Admin Master', 'S',sysdate,sysdate);
